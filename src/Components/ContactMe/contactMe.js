                ...
                <div className="row contactContainer">
                    <div className='p-0 mb-5 contact contactText'>
                        <a className='col-lg-6 email' href = "mailto: jasonwbessett@gmail.com">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="me-3 bi bi-envelope" viewBox="0 0 16 16">
                        ...
                        <a className='col-lg-6 phone' href='tel: 815-901-6344'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="me-3 bi bi-telephone" viewBox="0 0 16 16">
