...
import ResumeImg from "../../Images/Resume_v2.png"
        ...
        <div className="resume">
            <div className="resumeContainer row p-0 gx-6">
                <div className="col-lg-6 aboutRight ps-0">
                    ...
                    <img alt="Resume Image" className="resumeImg" src={require('../../Images/Resume_v2.png')}/>
                </div>
                <div className="col-lg-6 aboutLeft pe-0">
                    ...
                    <a href={require('../../Data/Resume_v2.pdf')} download="Bessett_Resume"><Buttin>Download and View</Buttin></a>
                </div>
            </div>
        </div>
    )
